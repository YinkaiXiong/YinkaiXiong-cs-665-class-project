 ...
 * Date: 04/27/2023
 * File Name: ConcreteFileSystem1.java
...
public class ConcreteFileSystem1 implements FileSystem {
  Database database;
   ...
   */
  public ConcreteFileSystem1(Database database) {
  ...
  public String readFile(String data) {
    ...
    return "File System 1 read file.\n" + database.connect() + "\n"
        + database.read(data);
  }
  ...
  public String writeFile(String data) {
    ...
    return "File System 1 write file.\n" + database.connect() + "\n"
